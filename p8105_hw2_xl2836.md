...
There are 60 distinct stations serve the A train and 15 of them are ADA compliant.
...
There are 404 unique locations included in the dataset. As there are 51 distinct states included in the dataset, which equals to the number of states in America, every state is represented in the dataset. By changing the `location_abbr` variable into factor and sorting it, we can find the New Jersey is observed most.
...
In 2002, the median of the "Excellent" response value is NA.
...
![](p8105_hw2_xl2836_files/figure-markdown_github/unnamed-chunk-14-1.png)
